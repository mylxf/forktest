...
public class ProductQueryServiceFacade {
    public PageResultDTO<List<ProductDTO>> queryProducts(Integer index, Integer size) throws EerigoRestClientException {
        ...
        return restClient.post("/queryProducts", request, PageResultDTO.class);
    }
}
